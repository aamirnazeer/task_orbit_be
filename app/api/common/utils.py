...
def create_access_token(created_user: Users, origin: str):
    encode = {'username': created_user.username, 'id': created_user.id, 'role': created_user.role, 'origin': origin}
...
def create_refresh_token(created_user: Users):
    encode = {'username': created_user.username, 'id': created_user.id, 'role': created_user.role}
